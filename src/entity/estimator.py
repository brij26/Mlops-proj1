...
class MyModel:
    ...
    def predict(self, dataframe: DataFrame) -> DataFrame:
        """
        Functions accepts preproccessed inputs(with all custom transformations already applied)
        applies scaling using preproccessing object, and performs prediction on transformed features.
        """
        try:
