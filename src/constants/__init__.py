...
MODEL_TRAINER_METRIC_ARTIFACT_DIR: str = "performance_metric"
MODEL_TRAINER_METRIC_ARTIFACT_NAME: str = "performance.json"
...
MODEL_BUCKET_NAME = "my-first-model-mlopsproj"
