...
class VehicleData:
    def __init__(self,
                 ...
                 Vehicle_Damage_Yes):
        """
        Vehicle Data cunstuctor
        Input : all feature of trained model for prediction
        """
        try:
            self.Gender = Gender
            self.Age = Age
            ...
            self.Previouly_Insured = Previously_Insured
    ...
    def get_vehicle_data_as_dict(self):
        ...
        """
        logging.info(
            "Entered get_vehicle_data_as_dict method of VehicleData class")
        try:
            input_data = {
                "Gender": [self.Gender],
                "Age": [self.Age],
                ...
                "Previously_Insured": [self.Previouly_Insured],
            ...
            logging.info(
                "Exited get_vehicle_data_as_dict method of VehicleData class")
            return input_data
...
class VehicleDataClassifier:
    def __init__(self, prediction_pipeline_config: VehiclePredictorConfig = VehiclePredictorConfig()) -> None:
        """
        :param prediction_pipeline_config: Configuration for prediction of the value
        """
        try:
