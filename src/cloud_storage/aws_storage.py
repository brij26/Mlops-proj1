...
class SimpleStorageService:
    """
    A class for interecting with AWS S3 Storage, providing methods for file management,
    ...
    def s3_key_path_available(self, bucket_name, s3_key) -> bool:
        """
        Checks if specified S3 key path(file path) is available in the specified bucket.
    ...
    def read_object(object_name: str, decode: bool = True, make_readable: bool = False) -> Union[StringIO, str]:
        ...
        Returns:
            booUnion[StringIO, str]: The content of the object, as a StringIO or decode string.
        """
    ...
    def get_bucket(self, bucket_name: str) -> Bucket:
        """
        Retrieves the S3 bucket object based on the porvided bucket name.
        ...
        """
        logging.info("Entered get_bucket method of SimpleStorageSevice class")
        try:
            bucket = self.s3_resource.Bucket(bucket_name)
            logging.info(
                "Exited get_bucket method of SimpleStorageSevice class")
            return bucket
        except Exception as e:
            raise MyException(e, sys) from e
    ...
    def get_file_object(self, filename: str, bucket_name: str) -> Union[List[object], object]:
        """
        Retrieves the file object(s) from the specified bucket based on the file name.
        ...
        Returns:
            Union[List[object], object] : The S3 file object or list of the file objects
        """
        logging.info(
            "Entered the get_file_object method of SimpleStorageService")
        try:
            bucket = self.get_bucket(bucket_name)
            file_objects = [
