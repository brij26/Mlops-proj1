...
def error_message_detail(error: Exception, error_detail: sys) -> str:
    ...
    :param error: The exception that occur
...
class MyException(Exception):
    """
    Custom exception class for handling errors in the our application.
    """

    def __init__(self, error_message: str, error_detail: sys):
        """
        Initialize the Exception with the detailed error message.
