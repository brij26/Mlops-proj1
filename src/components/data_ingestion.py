...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        Output      : data is returned artifact of data ingestion component
        On Failure  : Write an exception log and then raise an exception 
        """
        try:
            logging.info("Exporting data from mongodb")
            my_data = Proj1Data()
            dataframe = my_data.export_collections_as_dataframe(
    ...
    def split_data_as_train_test(self, dataframe: DataFrame) -> None:
        ...
        try:
            ...
            logging.info(
                "Exited split_data_as_train_test of DataIngestion class")
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        Output      : train set and test set are returned as the artifact of the data ingestion components
        On Failure  : Write an exception log and then raise an exception        
        """
        logging.info(
