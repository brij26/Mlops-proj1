...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        """
        Created and returns a data transformer object for the data,
        including gender mapping, dummy variable creation, column renaming,
        feature scaling, and type adjustments.
        """

        logging.info(
            "Entered get_data_transformer_object method of DataTransfomation class")
        ...
        try:
            ...
            logging.info(
                "Transfomers Initialized : StandardScaler - MinMaxScaler")

            # Load schema confugartions
            ...
            logging.info(
                "Exited get_data_transformer_object method of DataTransfomation class")
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        """
        Initiates the data transfomation component for the Pipeline.
        """
        try:
            ...
            logging.info("Got the Preproccesor object")

            logging.info("Initializing transformation for Training-data")
            input_feature_train_arr = preproccesor.fit_transform(
                input_feature_train_df)
            logging.info("Initializing transformation for Testing-data")
            input_feature_test_arr = preproccesor.transform(
                input_feature_test_df)
            logging.info("Transformation done end to end to train-test df.")

            logging.info("Appling SMOTEENN for handling imbalanced dataset.")
            ...
            save_object(
                self.data_transformation_config.transformed_object_file_path, preproccesor)
