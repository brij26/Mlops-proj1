...
class DataValidation:
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        Description : This method initiates the data validation component for the pipline
        ...
        try:
            ...
            if not status:
                ...
                logging.info(
                    f"All required columns are present in training dataframe : {status}")
            ...
            # Validation columns datatype for train/test df
            status = self.is_column_exist(df=train_df)
            if not status:
                validation_error_msg += f"Columns are missing in training dataframe."
            else:
                logging.info(
                    f"All categorical/numerical columns are present in training dataframe : {status}")
            ...
            if not status:
                ...
                logging.info(
                    f"All categorical/numerical columns are present in testing dataframe : {status}")
